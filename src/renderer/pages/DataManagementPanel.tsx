...
export default function DataManagementPanel() {
  ...
  return <div className="mx-auto max-w-6xl">
    ...
    <p className="mb-4 rounded-lg bg-zd-green-50 px-3 py-2 text-[10px] leading-relaxed text-gray-600">Account Landscape/Bullseye data uses <code>account_landscape_current.csv</code>. Upload that exact filename to populate Account ARR, current products, support plan, account health, seats, and recommendations.</p>
